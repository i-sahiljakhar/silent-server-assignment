...
const { authMiddleware, requestLogger } = require("./middleware/auth");
...
app.post("/auth/login", (req, res) => {
  try {
    ...
    console.log(`[OTP] Use this OTP: ${otp}`);
...
app.post("/auth/verify-otp", (req, res) => {
  try {
    const { loginSessionId, otp } = req.body;
        ...
        // DEBUG: Poora request body print karo
    console.log('=== VERIFY OTP DEBUG ===');
    console.log('Raw body:', req.body);
    console.log('loginSessionId:', loginSessionId);
    console.log('otp:', otp);
    console.log('Type of otp:', typeof otp);
    console.log('Stored OTP:', otpStore[loginSessionId]);
    console.log('========================');
